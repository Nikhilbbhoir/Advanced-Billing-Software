...
class supplierClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",15),fg="white",bg="#4caf50",cursor="hand2").place(x=980,y=79,height=28,width=100)
        ...
        # ========Buttons==========
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),fg="white",bg="#2196f3",cursor="hand2").place(x=180,y=370,height=35,width=110)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),fg="white",bg="#4caf50",cursor="hand2").place(x=300,y=370,height=35,width=110)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),fg="white",bg="#f44336",cursor="hand2").place(x=420,y=370,height=35,width=110)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),fg="white",bg="#607db8",cursor="hand2").place(x=540,y=370,height=35,width=110)
              ...
              messagebox.showerror("Error","Supplier no. must be required",parent=self.root)
                ...
                if row==None:                 
                    ...
                    if op==True:                    
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Supilier Deleted Successfully",parent=self.root)
                        self.clear()
