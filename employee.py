...
class employeeClass:
    def __init__(self,root):
        ...
        # ========options====
        cmb_search=ttk.Combobox(SearchFrame,values=("Select","Email","Name","Contact"),state='readonly',justify=CENTER,textvariable=self.var_searchby,font=("goudy old style",15))
        ...
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),fg="white",bg="#4caf50",cursor="hand2").place(x=410,y=9,height=30,width=150)

        # ======title====
        title=Label(self.root,text="Employee Details",bg="#0f4d7d",fg="white").place(x=50,y=100,width=1000)
        ...
        cmb_gender=ttk.Combobox(self.root,values=("Select","Male","Female","Not prefer to say"),state='readonly',justify=CENTER,textvariable=self.var_gender,font=("goudy old style",15))
        ...
        lbl_pass=Label(self.root,text="Passowrd",font=("goudy old style",15),bg="white").place(x=350,y=230)
        ...
        cmb_utype=ttk.Combobox(self.root,values=("Admin","Employee"),state='readonly',justify=CENTER,textvariable=self.var_utype,font=("goudy old style",15))
        ...
        # ========Buttons==========
        btn_add=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),fg="white",bg="#2196f3",cursor="hand2").place(x=500,y=305,height=28,width=110)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),fg="white",bg="#4caf50",cursor="hand2").place(x=620,y=305,height=28,width=110)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),fg="white",bg="#f44336",cursor="hand2").place(x=740,y=305,height=28,width=110)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),fg="white",bg="#607db8",cursor="hand2").place(x=860,y=305,height=28,width=110)
